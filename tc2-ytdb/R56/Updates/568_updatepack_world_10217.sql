# Y2kCat
ALTER TABLE db_version_ytdb CHANGE COLUMN 567_FIX_10093 568_FIX_10217 bit;
REPLACE INTO `db_version_ytdb` (`version`) VALUES ('568_FIX_10217');
...
(3211,'Corpulous great cook of Acherus who make good food for you. He proud to feed mighty Scourge and make stronger. No make Corpulous mad, he no feed you.$B$BRules:$B$BDeath Knight eat first, ghoul wait turn.$B$BNo eat ghoul next to you. Need clean plate first.$B$BOk add own maggots and lice to food. Corpulous not offended.$B$BGot vermin? Bring to Corpulous!$B$BOk eat human or elf. Elf other white meat.$B',3212,12340),
(3212,'Mess part of meal. Corpulous see napkin, Corpulous hang head in shame.$B$BOk bring back food not rotten enough. Corpulous got three free armpits.$B$BOk eat with hands or swords. No eat hands or swords.$B$BZombie need try more food. Think outside the brains.$B$BNo eat self.',0,12340);
update creature_template set vehicleid=562 where entry=36896;
INSERT IGNORE INTO `vehicle_accessory` VALUES ('36896', '28717', '0', '0', 'Overlord Drakuru');
DELETE FROM creature_formations WHERE leaderGUID IN (124336,124337,124338,125677,125690);
update creature_template set vehicleid=560 where entry=36891;
update creature_template set vehicleid=522 where entry=36476;
update creature_template set vehicleid=551 where entry in (36794);
INSERT IGNORE INTO `vehicle_accessory` VALUES ('36794', '36658', '0', '0', 'Scourgelord Tyrannus');
INSERT IGNORE INTO `vehicle_accessory` VALUES ('36661', '36658', '0', '0', 'Scourgelord Tyrannus');
update creature_template set vehicleid=535 where entry in (36661);
...
# Hacker
UPDATE `script_texts` SET `language`=1 WHERE `entry`=-1000600;
...
DELETE FROM `page_text` WHERE `entry` IN (3211,3212);
INSERT INTO `page_text` (`entry`,`text`,`next_page`, WDBVerified) VALUES
(3211,'Corpulous great cook of Acherus who make good food for you. He proud to feed mighty Scourge and make stronger. No make Corpulous mad, he no feed you.$B$BRules:$B$BDeath Knight eat first, ghoul wait turn.$B$BNo eat ghoul next to you. Need clean plate first.$B$BOk add own maggots and lice to food. Corpulous not offended.$B$BGot vermin? Bring to Corpulous!$B$BOk eat human or elf. Elf other white meat.$B',3212, `WDBVerified`=12340),
(3212,'Mess part of meal. Corpulous see napkin, Corpulous hang head in shame.$B$BOk bring back food not rotten enough. Corpulous got three free armpits.$B$BOk eat with hands or swords. No eat hands or swords.$B$BZombie need try more food. Think outside the brains.$B$BNo eat self.',0, `WDBVerified`=12340);
...
REPLACE INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `bytes2`, `auras`) VALUES ('24896', '0', '1', '0', NULL);
...
# timmit
UPDATE `creature_template` SET `minlevel` = 80, `maxlevel` = 80, `faction_A` = 16, `faction_H` = 16, `baseattacktime` = 5000, `rangeattacktime` = 5000, `unit_class` = 2, `InhabitType` = 4, `flags_extra` = 2 WHERE `entry` = 36967;
UPDATE `creature_template` SET `faction_A` = 16, `faction_H` = 16, `flags_extra` = 2 WHERE `entry` = 36508;
DELETE FROM `creature_template_addon` WHERE (`entry`=36508);
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES (36508, 0, 33554432, 1, 0, 0, '');
...
UPDATE `creature_template` SET `minlevel` = 83, `maxlevel` = 83, `unit_flags` = 33554432, `flags_extra` = 2 WHERE `entry` = 36536;
...
DELETE FROM `waypoint_data` WHERE `id`=74697;
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 74697, `path_id`= 74697;
INSERT INTO `event_scripts` VALUES ('5991', '5', '7', '6001', '0', '0', '0', '0', '0', '0');
INSERT INTO `event_scripts` VALUES ('6028', '5', '7', '6002', '0', '0', '0', '0', '0', '0');
...
UPDATE `creature_template` SET `minlevel` = 16, `maxlevel` = 18 WHERE `entry` = 8996;
...
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =20570;
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =11686;
...
INSERT IGNORE INTO `event_scripts` VALUES ('14525', '1', '10', '20555', '180000', '0', '3705.15', '5386.27', '-4.06', '5.11');
...
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =169;
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =1060;
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =1126;
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =4626;
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =10811;
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =16480;
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =17035;
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 135305, `path_id`= 135305;
DELETE FROM `creature_template_addon` WHERE (`entry`=36896);
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES (36896, 0, 0, 1, 0, 536576, '');
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 123558, `path_id`= 123558;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 123559, `path_id`= 123559;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 123560, `path_id`= 123560;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 123561, `path_id`= 123561;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 124320, `path_id`= 124320;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 102296, `path_id`= 102296;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 102307, `path_id`= 102307;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 102366, `path_id`= 102366;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 104089, `path_id`= 104089;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 104090, `path_id`= 104090;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 104091, `path_id`= 104091;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 104092, `path_id`= 104092;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 104093, `path_id`= 104093;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 104094, `path_id`= 104094;
...
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (30850, 0.4464, 1.8, 0, 30851);
DELETE FROM `creature_model_info` WHERE (`modelid`=30851);
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (30851, 0.4464, 1.8, 1, 0);
DELETE FROM `creature_model_info` WHERE (`modelid`=30849);
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (30849, 0.383, 1.5, 1, 0);
DELETE FROM `creature_model_info` WHERE (`modelid`=30848);
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (30848, 0.383, 1.5, 0, 30849);
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 124336, `path_id`= 124336;
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 124337, `path_id`= 124337;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 124338, `path_id`= 124338;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT IGNORE INTO `creature_addon` SET `guid`= 124325, `path_id`= 124325;
-- 36830
...
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (30364, 0.520833, 2.25, 0, 0);
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (30347, 2, 0, 2, 0);
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES 
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES (36794, 0, 50331648, 1, 0, 0, '');
DELETE FROM `creature_model_info` WHERE (`modelid`=27982);
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (27982, 0.93, 9.9, 2, 0);
...
INSERT INTO `creature_model_info` (`modelid`, `bounding_radius`, `combat_reach`, `gender`, `modelid_other_gender`) VALUES (30843, 0.5425, 7.875, 0, 0);
...
UPDATE `creature_template` SET `minlevel` = 80, `maxlevel` = 80, `unit_flags` = 33587200 WHERE `entry` = 36847;
...
INSERT INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES (36877, 0, 67108864, 1, 0, 0, '');
...
INSERT INTO `gossip_scripts` (`id`, `delay`, `command`, `datalong`) VALUES ('50143', '0', '15', '54974'), ('50144', '0', '15', '54976');
INSERT INTO `gossip_scripts` (`id`, `delay`, `command`, `datalong`) VALUES ('50145', '0', '15', '55008'), ('50146', '0', '15', '55006');
...
REPLACE INTO `creature_addon` (`guid`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES ('127863', '0', '0', '1', '0', '0', '29266 0 29266 1'), ('127865', '0', '0', '1', '0', '0', '29266 0 29266 1');
REPLACE INTO `creature_addon` (`guid`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES ('127867', '0', '0', '1', '0', '0', '29266 0 29266 1'), ('127868', '0', '0', '1', '0', '0', '29266 0 29266 1');
REPLACE INTO `creature_addon` (`guid`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES ('127869', '0', '0', '1', '0', '0', '29266 0 29266 1'), ('127870', '0', '0', '1', '0', '0', '29266 0 29266 1');
REPLACE INTO `creature_addon` (`guid`, `mount`, `bytes1`, `bytes2`, `emote`, `path_id`, `auras`) VALUES ('127864', '0', '0', '0', '68', '0', ''), ('127866', '0', '0', '0', '68', '0', '');
...
# Forum_FIX
UPDATE `creature_template` SET `minlevel` = 70, `maxlevel` = 70, `faction_A` = 14, `faction_H` = 14 WHERE `entry` = 37937;
...
# INSERT INTO `spell_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`) VALUES ('49466', '1', '15', '47523', '1');
...
(12614, 0, 0, 0, 28451, 2000000414, 0, 0, 0, 0),
(12614, 2, 0, 0, 28451, 2000000415, 0, 0, 0, 0),
(12614, 4, 0, 0, 28451, 2000000416, 0, 0, 0, 0),
(12614, 6, 0, 0, 28451, 2000000417, 0, 0, 0, 0),
(12614, 8, 0, 0, 28451, 2000000418, 0, 0, 0, 0),
(12614, 10, 0, 0, 28451, 2000000419, 0, 0, 0, 0),
(12614, 12, 0, 0, 28451, 2000000420, 0, 0, 0, 0),
(12614, 14, 0, 0, 28451, 2000000421, 0, 0, 0, 0),
(12614, 17, 0, 0, 28376, 2000000422, 0, 0, 0, 0);
...
UPDATE `creature_template` SET `flags_extra` = `flags_extra`&~128 WHERE `modelid1` =1061;
...
# Conditions
REPLACE INTO `gossip_menu_option` VALUES ('9832', '8', '0', 'I\'ve lost my Tabard of Blood Knight.', '1', '1', '0', '0', '50143', '0', '0', null);
REPLACE INTO `gossip_menu_option` VALUES ('9832', '9', '0', 'I\'ve lost my Tabard of the Hand.', '1', '1', '0', '0', '50144', '0', '0', null);
REPLACE INTO `gossip_menu_option` VALUES ('9832', '10', '0', 'I\'ve lost my Tabard of the Protector.', '1', '1', '0', '0', '50145', '0', '0', null);
REPLACE INTO `gossip_menu_option` VALUES ('9832', '11', '0', 'I\'ve lost my Tabard of the Achiever.', '1', '1', '0', '0', '50146', '0', '0', null);
REPLACE INTO `gameobject_loot_template` VALUES ('192050', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192051', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192048', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192049', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192046', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192052', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192053', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192054', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `gameobject_loot_template` VALUES ('192057', '50289', '0.2', '1', '1', '1', '1');
REPLACE INTO `conditions` VALUES ('4', '192050', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192051', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192048', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192049', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192046', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192052', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192053', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192054', '50289', '0', '12', '45', '0', '0', '0', '', null);
REPLACE INTO `conditions` VALUES ('4', '192057', '50289', '0', '12', '45', '0', '0', '0', '', null);
...
# REPLACE INTO `conditions` VALUES ('15', '9832', '11', '0', '20', '1021', '0', '0', '0', '', null);
# REPLACE INTO `conditions` VALUES ('15', '9832', '8', '0', '16', '25549', '1', '0', '0', '', null);
# REPLACE INTO `conditions` VALUES ('15', '9832', '9', '0', '16', '24344', '1', '0', '0', '', null);
# REPLACE INTO `conditions` VALUES ('15', '9832', '10', '0', '16', '28788', '1', '0', '0', '', null);
# REPLACE INTO `conditions` VALUES ('15', '9832', '11', '0', '16', '40643', '1', '0', '0', '', null);
...
UPDATE version SET `cache_id`= '568';
UPDATE version SET `core_revision`= '10217';
UPDATE version SET `db_version`= 'YTDB_0.13.9_R568_TC_R10217_TDBAI_335.0.1_RuDB_R38.3';
